...
defmodule Bunq.Model.NoteAttachmentIdealMerchantTransactionListing do
  @moduledoc """
...
defimpl Poison.Decoder, for: Bunq.Model.NoteAttachmentIdealMerchantTransactionListing do
