...
defmodule Bunq.Model.NoteAttachmentSofortMerchantTransactionListing do
  @moduledoc """
...
defimpl Poison.Decoder, for: Bunq.Model.NoteAttachmentSofortMerchantTransactionListing do
