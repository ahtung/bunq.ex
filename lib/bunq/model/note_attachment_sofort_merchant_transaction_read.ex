...
defmodule Bunq.Model.NoteAttachmentSofortMerchantTransactionRead do
  @moduledoc """
...
defimpl Poison.Decoder, for: Bunq.Model.NoteAttachmentSofortMerchantTransactionRead do
