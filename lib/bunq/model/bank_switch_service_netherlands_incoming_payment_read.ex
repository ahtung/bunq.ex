...
defmodule Bunq.Model.BankSwitchServiceNetherlandsIncomingPaymentRead do
  @moduledoc """
...
defimpl Poison.Decoder, for: Bunq.Model.BankSwitchServiceNetherlandsIncomingPaymentRead do
