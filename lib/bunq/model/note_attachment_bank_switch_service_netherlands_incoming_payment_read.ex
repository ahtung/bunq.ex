...
defmodule Bunq.Model.NoteAttachmentBankSwitchServiceNetherlandsIncomingPaymentRead do
  @moduledoc """
...
defimpl Poison.Decoder, for: Bunq.Model.NoteAttachmentBankSwitchServiceNetherlandsIncomingPaymentRead do
